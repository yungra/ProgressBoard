                    ...
                    <section class="text-gray-600 body-font">
                        <div class="container px-5 mx-auto">
                            ...
                            <div class="flex justify-end mb-4">
                                <button onclick="location.href='{{ route('admin.notice.create') }}'"
                                        ...
                                        @foreach ($notices as $notice)
                                            <tr>
                                                ...
                                                @if ($notice->is_student)
                                                    <td class="px-4 py-3">生徒向け</td>
                                                    {{-- 講師向けのお知らせだった場合 --}}
                                                @else
                                                    <td class="px-4 py-3">講師向け</td>
                                                @endif
                                                <td class="px-4 py-3">{{ $notice->subject }}</td>
                                                <td class="px-4 py-3">{{ $notice->created_at }}</td>
                                                <td class="px-4 py-3">
                                                    <button
                                                        onclick="location.href='{{ route('admin.notice.show', $notice->id) }}'"
