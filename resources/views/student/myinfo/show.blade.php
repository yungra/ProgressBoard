                    ...
                    <section class="text-gray-600 body-font relative">
                        <div class="container px-5 mx-auto">
                          ...
                          <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            ...
                            <form method="get" action="{{ route('student.myinfo.edit', ['id' => $myinfo->id]) }}">
                              {{-- @method('PUT')   --}}
                              {{-- @csrf --}}
                            <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                              ...
                              <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                  ...
                                  <input type="school" id="school" name="school" value="{{ $myinfo->school->name}}" readonly class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                              </div>
                              ...
                              <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                  ...
                                  <input type="desired_school" id="desired_school" name="desired_school" value="{{ $myinfo->desired_school->name}}" readonly class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                              </div>
