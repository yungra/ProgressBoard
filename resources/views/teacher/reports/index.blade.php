    ...
    <x-slot name="header">
        ...
        <form method="GET" action={{ route('teacher.reports.index') }}>
            <div class="flex space-x-2 items-center">
                <div><input type="text" name="keyword" class="border border-gray-500 py-2" placeholder="生徒名で検索"></div>
                    ...
                    <section class="text-gray-600 body-font">
                        <div class="container px-5 mx-auto">
                            <div class="flex justify-end mb-4">
                                <button onclick="location.href='{{ route('teacher.reports.create') }}'"
                                        ...
                                        @foreach ($reports as $report)
                                            <tr>
                                                ...
                                                <td class="md:px-4 py-3">
                                                    <button
                                                        onclick="location.href='{{ route('teacher.reports.show', $report->id) }}'"
                                                ...
                                                @if ($report->questionnaire !== null)
                                                    <td class="md:px-4 py-3">
                                                        <button
                                                            onclick="location.href='{{ route('teacher.questionnaire.show', $report->id) }}'"
