                    ...
                    <section class="text-gray-600 body-font relative">
                        <div class="container px-5 mx-auto">
                            <div class="flex flex-col text-center w-full mb-12">
                                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">指導報告書</h1>
                            </div>
                            <div class="w-full">
                                                ...
                                                <div class="p-2 w-1/2 mx-auto">
                                                    <div class="relative">
                                                        ...
                                                        <input type="text" id="name" name="name"
                                                            value="{{ $report->student->name }}" readonly
                                                ...
                                                <div class="p-2 w-full mx-auto">
                                                    <div class="relative">
                                                        ...
                                                        <textarea type="text" id="report" name="report" value="{{ $report->report }}" readonly
                                                            ...
                                                            class="w-full h-96 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ $report->report }}</textarea>
                                                    </div>
                                                </div>
